        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-12 lg:gap-20">
          <div className="flex-1 text-center lg:text-left max-w-2xl">
            <motion.h1
              ...
              style={{ color: theme.heading, fontFamily: "'Inter', sans-serif" }}
            ...
            <motion.p
              ...
              style={{ fontSize: '25px', color: theme.text, fontFamily: "'Inter', sans-serif" }}
            ...
            <motion.p
              className="hidden sm:block font-normal leading-relaxed mb-6 sm:mb-8 max-w-xl mx-auto lg:mx-0"
              style={{ fontSize: '17px', color: theme.textSecondary, fontFamily: "'Inter', sans-serif" }}
              initial={{ opacity: 0, x: -30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.7, delay: 0.3, ease: 'easeOut' }}
            >
              Dedicated Software Developer with 4+ years of experience in full-stack development, specializing in React.js, Node.js, and MySQL. Developed scalable and secure web applications and high-performance REST APIs, with strong expertise in writing clean, maintainable code and implementing security best practices. Working closely with cross-functional teams to deliver robust solutions that drive business growth.
            </motion.p>
            <motion.div
            ...
            >
              <a
                href="#projects"
                className="btn-3d-resume w-full sm:w-auto inline-block px-6 sm:px-10 py-3 sm:py-4 font-bold text-base sm:text-lg text-center"
                style={{ color: '#1c2b3a' }}
              >
                See My Projects
              </a>
              <a
                ...
                className="btn-3d-resume w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 sm:px-10 py-3 sm:py-4 font-bold text-base sm:text-lg"
                style={{ color: '#1c2b3a' }}
              >
                <FaDownload size={16} />
                Download Resume
